...
if ($_POST[startArchive]){
	...
	$cmd2Format="$flame_archive -f -F $_POST[archiveName] -i $_POST[chunk] -n $_POST[projects]";
	$cmd2Archive="$flame_archive -a -P $_POST[projects] -F $_POST[archiveName]";
	//echo "\n<br>$cmd2Format<br>\n";//

	echo exec($cmd2Format);
	...
	echo "<input type=button name='otoc' value='HTML OTOC' onclick=\"window.location.href='../archive/$www_otoc_file';\">";
}else{
...
<tr>
<td colspan=4 style="text-align:center;"><input type="submit" value="Start Archive" name="startArchive" id="startArchive"></td>
</tr>
